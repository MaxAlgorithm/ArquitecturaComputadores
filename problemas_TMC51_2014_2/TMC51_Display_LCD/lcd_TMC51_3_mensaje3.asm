;===================================
;lcd_TMC51_3_mensaje.asm
;Programa que muestra 
;El mensaje "Arquitectura de Computadores"
;===================================
...
; ----------------------------------------------------
; localiza el cursor sobre la línea 1, posición 0 y imprime un mensaje
    	mov   a, #1        	; fila 1
    	mov   b, #0        	; posición 0
    	lcall placeCur4	   	; localiza el cursor
    	lcall prtLCD4      	; muestra mensaje
    	db "MODULO"
    	db 0
; localiza el cursor sobre la línea 2, posición 4 y imprime un mensaje
    	mov   a, #2        ; fila 2
    	mov   b, #0        ; posición 1
    	lcall placeCur4	   ; localiza el cursor	
    	lcall prtLCD4      ; muestra mensaje
  	...
  	mov r0,#offcur
    	...
    	lcall delay     ;
        lcall print
        db "Presione Ctrl-C para terminar...."
        db 0
otra:
    	mov   r0, #offDsp
    	lcall wrLCDcom4
...
;INICIA DESPLAZAMIENTO A LA IZQUIERDA
    	mov r7,#16
lazo_:
    	mov a,#1
    	lcall dspshlf4
    	...
    	lcall DELAY
    	lcall chkbrk
;INICIA DESPLAZAMIENTO A LA DERECHA
    	mov r7,#16
lazo:
    	mov a,#1
    	lcall dspshrt4
